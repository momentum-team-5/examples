...
#    path('contacts/<int:pk>/notes/delete/', contacts_views.delete_note, name='delete_note'),
#    path('contacts/<int:pk>/notes/update/', contacts_views.update_note, name='update_note')
]
